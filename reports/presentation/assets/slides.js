...
const SLIDES = [
  ...
  { file: '03-problem-hook.html',        title: '문제 제기' },
  { file: '04-problem-analysis.html',    title: '문제 분석' },
  { file: '04b-problem-definition.html', title: '문제 정의' },
  { file: '04c-solution-approach.html',  title: '해결 방향' },
  { file: '05-wbs.html',                 title: 'WBS · 작업 일정' },
  { file: '06-data-collection.html',     title: '데이터 수집' },
  { file: '07-feature-engineering.html', title: 'Feature Engineering' },
  { file: '08-ml-models.html',           title: 'ML 모델' },
  { file: '09-model-results.html',       title: '모델 평가 결과' },
  { file: '17-demo-intro.html',          title: '화면 시연 (라이브)' },
  { file: '17-demo-fullscreen.html',     title: '라이브 데모 전체 화면' },
  { file: '18-future-plan.html',         title: '향후 계획' },
  { file: '19-closing.html',             title: '마무리' },
  { file: '21-qa.html',                  title: 'Q&A' },
];
