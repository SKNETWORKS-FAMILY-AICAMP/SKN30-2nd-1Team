...
| 15 EDA | 차트 이미지 3개 | `assets/eda/category_dist.png`, `churn_label.png`, `corr_heatmap.png` |
| 06 화면 시연 | fallback 스크린샷 | `assets/screenshots/demo.png` |
| 22 회고 | 한 줄 회고 5명 | `slides/22-results-retrospective.html` 의 `<!-- 한 줄 회고 입력 -->` |
