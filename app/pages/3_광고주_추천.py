...
# ---- 탭 ----
tab_long, tab_short, tab_cat = st.tabs(["장기 계약 추천", "단기 계약 추천", "카테고리 추천"])
...
with tab_short:
    st.info("단기 계약 추천 탭은 디자인 시안에서는 장기 계약 추천 탭과 동일한 패턴을 사용합니다.")

with tab_cat:
    st.info("카테고리 추천 탭은 디자인 시안에서는 장기 계약 추천 탭과 동일한 패턴을 사용합니다.")
